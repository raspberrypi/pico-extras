...
// Offsets must be between 0 and 2
// Offsets are relative to PICO_SCANVIDEO_SYNC_PIN_BASE
#ifndef PICO_SCANVIDEO_HSYNC_PIN_OFFSET
#define PICO_SCANVIDEO_HSYNC_PIN_OFFSET 0
#endif

#ifndef PICO_SCANVIDEO_VSYNC_PIN_OFFSET
#define PICO_SCANVIDEO_VSYNC_PIN_OFFSET 1
#endif

#ifndef PICO_SCANVIDEO_DEN_PIN_OFFSET
#define PICO_SCANVIDEO_DEN_PIN_OFFSET 2
#endif

#ifndef PICO_SCANVIDEO_CLOCK_PIN
#define PICO_SCANVIDEO_CLOCK_PIN (PICO_SCANVIDEO_SYNC_PIN_BASE + 3)
#endif
